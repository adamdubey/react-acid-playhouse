  ...
  const RenderArrows = () => {
    return (
      <div className="slider-arrows">
        <div className="slider-arrow slider-arrow--left" onClick={() => showSlideArrow('prev')} />
        <div className="slider-arrow slider-arrow--right" onClick={() => showSlideArrow('next')} />
      </div>
    );
  };
